    ...
    $(document).on("click",".next-step", function(){		
		...
		if($(this).attr("id") == "save_general"){						
			...
			if($("#product_name").val() == "")
			{
                ...
                var faulty_price 	        = $("#faulty_price").val();				
				...
				$.ajax({
					type:"POST",
					url : baseurl+"en/admin/products/edit_generalinfo/",
					/*data:{  
							productid:productid,
			...
			*/
			...
			$.ajax({
				...
				url:baseurl+"en/admin/products/add_attributeValue",
				type:'POST',
