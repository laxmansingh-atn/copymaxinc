...
class AuthorizeNetAIM_Sandbox_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testAimResponseFields()
    {
        ...
        $this->assertGreaterThan(1, safe_strlen($response->authorization_code));
        $this->assertEquals("Y", $response->avs_response);
        $this->assertGreaterThan(1, safe_strlen($response->transaction_id));
        ...
        $this->assertGreaterThan(1, safe_strlen($response->md5_hash));
