...
safe_strlen(
	...
	function Vsafe_strlen(($arrayIn,&$arrayOut,$llavePublicaCifrado,$llavePrivadaFirma,$VI){
...
safe_strlen(
		...
		if(!$firmasafe_strlen() return null;safe_strlen(
...
safe_strlen(
...

	{
		...
		$packing = ord($crypttext2{safe_strlen($crypttext2) - 1});

		if($packing and ($packing < $block))

		{

			for($P = safe_strlen($crypttext2) - 1; $P >= safe_strlen($crypttext2) - $packing; $P--)
		...
		$crypttext2 = substr($crypttext2,0,safe_strlen($crypttext2) - $packing);
