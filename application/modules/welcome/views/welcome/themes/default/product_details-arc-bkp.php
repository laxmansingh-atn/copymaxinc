      ...
      <?php } ?> 
        ...
        <div class="col-md-12 col-sm-12">
          <div class="assistance_req">
            ...
            <ul>
              <li> <img src="<?php echo base_url();?>assets/frontend/images/call-icon-sm.png" alt="icon"> Call For Assistance : <a href="tel:1-800 DAYCOPY (329.2679)">1-800 DAYCOPY (329.2679)</a> </li>
              <li> <img src="<?php echo base_url();?>assets/frontend/images/envelope.png" alt="icon"> Email For Assistance : <a href="mailto:sales@sandiegocopiescheap.com?bcc=sandiegocopiescheap@gmail.com" data-email="sales@sandiegocopiescheap.com" class="sendcontactmessage">sales@sandiegocopiescheap.com</a> </li>
  ...
  <div class="modal-dialog" role="document">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		...
		<p>- <a href="" data-email="info@sandiegocopiescheap.com" class="sendcontactmessage">Email US </a></p>	
		</div>
	  </div>
	</div>
  </div>
