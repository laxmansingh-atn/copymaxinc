      ...
      <?php } ?> 
        ...
        <div class="col-md-12 col-sm-12">
          <div class="assistance_req">
            ...
            <ul>
              <li> <img src="<?php echo base_url();?>assets/frontend/images/call-icon-sm.png" alt="icon"> Call For Assistance : <a href="tel:1-844-Copymax (2679629)">1-844-Copymax (2679629)</a> </li>
    ...
    <div class="modal-content">
      <div class="modal-body continue_dialog_body" style="padding: 5px;">
        ...
        <div style="border: 10px solid black;padding: 15px;">
          ...
          <p><span>FREE SHIPPING/DELIVERY </span> orders over $500 will be delivered/shipped ground free of charge</p>
