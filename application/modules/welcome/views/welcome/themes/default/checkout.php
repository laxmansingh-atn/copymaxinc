    ...
    <?php  if($this->session->flashdata('payment_details')): 
      ...
      <?php if ($this->ion_auth->logged_in()) { ?>
        <?php echo form_open('place_order'); ?>
          ...
          <div class="form color-coded green">
            <div class="container">
              <h4 style="display: inline-block; line-height: 50px;">Your delivery options here</h4>
              <!--<button>UPDATE ORDER</button>-->
              <div class="block form-row sship-time-of-day optional-row">
                <label>PICKUP TIME:</label>
                <div class="no-info sship-time-of-day" style="display: block;"><?=!empty($session_data['delivery_time'])?$session_data['delivery_time']:'--';?></div>
                <select name="pickup_time" style="display: none;">
                  <option value="4.00 P.M">4.00 P.M</option>
                </select>
              </div>
              <div class="block form-row arrival-date optional-row">
                <label>PICKUP DATE:</label>
                <div><?=!empty($session_data['date'])?$session_data['date']:'';?></div>
              </div>
              <!-- <div class="block form-row zipcode" style="display: none;">
                <label>ZIP CODE:</label>
                <input type="hidden" name="zip_code" value="">
              </div> -->
              <div class="block form-row shipping_method">
                <label>DELIVERY METHOD:</label>
                <div><?php echo $session_data['shipping_type'];?></div>
              </div>
              <input type="hidden" id="quote-state" value="valid">
            ...
            <div class="row clearfix">
              <div class="col-md-12">
                <table class="table table-bordered">
                  ...
                  <tbody>
  				          <?php foreach($cart_content as $conent){ ?>
                      <tr>
                        <td><?=$conent['name']?></td>
                        <td><?=number_format($conent['price'],2)?></td>
  					          ...
  					          <tr>
                        <td>
  					              <?php if($conent['priniting_details']){ echo safe_str_replace('||',':' , $conent['priniting_details']);}?> </td>
                        <td>
  					              <?php if($conent['finishing_details']){
                            echo safe_str_replace('||', ':' , $conent['finishing_details']); 					
  					              } ?> 
                        </td>
                      </tr>
  				          <?php } ?>
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <td>$<?=number_format($additional_charges,2);?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <th>Total</th>
                      <td>$<?=number_format(($cart_sub_total),2); ?></td>
                    ...
                    <!--<div class="panel panel-default">
                      <div class="panel-heading">
                        <h4 class="panel-title">
                          <label for="r11">
                            <input type="radio" id="r11" name="payment_method" class="payment_method" value="cod" required />
          ...
          <input type="hidden" name="shipping_amount" value="<?php if(isset($shipping_amount) && $shipping_amount) { echo $shipping_amount;}else{ echo '0.00'; }?>">
