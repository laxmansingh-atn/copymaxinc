...
<div class="row clearfix">
      <div class="col-md-12">
        <div class="upload_pg">
			<!--div class="mgs text-center">
				<p><!--If you have any problems with uploading your file(s) please place your order without uploading your file(s) and we will send you a link to upload your files. Sorry for any inconvenience.- ->Maximum file upload size is 400mb, if your file is larger than 400mb please place your order without uploading your file and we will send you a link to upload your file(s). Sorry for any inconvenience.</p>
			</div-->
              ...
              <div class="row clearfix">
                <div class="col-md-8">
                  <div class="inprogress">
                    <h3>File Upload In Progress <?php //echo base_url(); ?></h3>
                  ...
                  <!-- <div class="col-md-12" id="progress_bar" style="display:none;">
					...
					<div class="mgs text-center">
						<p style="font-size:medium"><!--If you have any problems with uploading your file(s) please place your order without uploading your file(s) and we will send you a link to upload your files. Sorry for any inconvenience.-->Maximum file upload size is 400mb, if your file is larger than 400mb please place your order without uploading your file and we will send you a link to upload your file(s). Sorry for any inconvenience.</p>
					</div>
					...
					<div class="row clearfix">
						<div class="col-md-12 col-sm-12">
							<div class="update_shipping_quote">
								<h3>Choose your completion date & delivery method</h3>
								<div class="quote_box">
									...
									<div class="form-group">
										...
										<div class="inputFld">
											<select id="shipping_type" name="shipping_type">
												...
												//if (($this->cart->total() >= 500) && ($this->cart->total() < 200)) : ?>
													<!--<option value="regular">Free Regular UPS Ground</option>-->
												<?php  if ($total_cart_ship >= 500) : ?>
									...
									<div class="form-group address">
										<div id="delivery_address_div" style="display:none;">
											...
											<div class="inputFld">
												<b><!--Pick up at our partner Facility only-->Pick up location:<br>
													Copymax<br>
													802 North twin oaks valley road<br>
													STE 108, San Marcos, CA 92069<br>
													1-844-267-9629</b>
											</div>
										</div>
						...
						<div class="col-md-12 col-sm-12">
							...
							<p style="font-size: 14px;font-weight: bold;color: red;margin-top: 10px;">Our cut off time is any business day 11:00am, completion date displayed in dark green gives you the lowest pricing.<!--orders PLACED BEFORE 11AM will be ready FOR PICK UP AFTER TWO BUSINESS DAYS AT 4PM.--></p>
							<p style="font-size: 18px;font-weight: 800;color: red;margin-top: 10px;">Rush service available, call for details 1-844-267-9629</p>
						</div>
					</div>
				</div>
