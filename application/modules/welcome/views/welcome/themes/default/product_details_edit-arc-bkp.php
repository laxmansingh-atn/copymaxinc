      ...
      <?php } ?> 
        ...
        <div class="col-md-12 col-sm-12">
          <div class="assistance_req">
            ...
            <ul>
              <!--<li> <img src="<?php echo base_url();?>assets/frontend/images/call-icon-sm.png" alt="icon"> Call Service <a href="#">123 456 7890</a> </li>			 <li> <img src="<?php echo base_url();?>assets/frontend/images/envelope.png" alt="icon"> Email Service <a href="#">Email Form</a> </li>			 <li> <img src="<?php echo base_url();?>assets/frontend/images/clock.png" alt="icon"> Phone Business <span>Hours Mon - Fri 8:30 AM - 5:30 PM PST</span> </li>-->			 			 <li> <img src="<?php echo base_url();?>assets/frontend/images/call-icon-sm.png" alt="icon"> Call For Assistance : <a href="tel:1-800 DAYCOPY (329.2679)">1-800 DAYCOPY (329.2679)</a> </li>              <li> <img src="<?php echo base_url();?>assets/frontend/images/envelope.png" alt="icon"> Email For Assistance : <a href="mailto:sales@sandiegocopiescheap.com?bcc=sandiegocopiescheap@gmail.com" data-email="sales@sandiegocopiescheap.com" class="sendcontactmessage">sales@sandiegocopiescheap.com</a> </li>              <li> <img src="<?php echo base_url();?>assets/frontend/images/clock.png" alt="icon"> Phone Business <span>Hours Mon - Fri 8:30 AM - 5:30 PM PST</span> </li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-lg continue_dialog" style="width:1300px;margin: 5px auto;">
    ...
    <div class="modal-content">
      <div class="modal-body continue_dialog_body" style="padding: 5px;">
        ...
        <div style="border: 10px solid black;padding: 15px;">
          <h1>THINGS YOU SHOULD KNOW WHEN YOU PLACE YOUR ORDER</h1>
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="bleed-content">
                <p><span><u>BLEED or NO BLEED </u></span>If the printing goes all the way to the edge it’s called bleed & requires special design, we will print on larger paper and cut to size so there is no white around the sheet.</p>
          ...
          <h2>WHAT HAPPENS AFTER YOU PLACE YOUR ORDER</h2>
          ...
          <p><span>ANY QUESTIONS</span> please contact us before or during placing your oder.</p>
          <div class="row">
              <div class="col-md-3">
