   ...
   //Login & Registration
	...
	public function product_details()
	{
		...
		if($slug != ""){
		   ...
		   // $id	= $this->home_model->get_val('tbl_products', 'product_slug', $slug, 'product_id');
		     $id = $product_data['product_id'];
			$data['page_slug']       =  end($this->uri->segments);
            $data['header_content']  =  $this->home_model->Show_Page(get_current_language());			
		    $data['product_details'] =  $this->home_model->getProductDetails($id) ; 
            $data['image_list']      =   $this->home_model->getProductImage($id);
            //$data['varient_value']   =   $this->input->post('varient_value');
            //$data['varient_price']   =   $this->input->post('varient_price');
	       ...
	       //$data['show_networks']    =   $this->home_model->Show_Networks();
