...
class Products extends MY_Controller {
...

	{
		...
		//echo "<pre>";print_r($data['product_paper']);die();
		...
		if ($this->input->post()) {
			...
			$this->db->delete('tbl_product_printing_price');								for ($i=0; $i < count($this->input->post('front_cover_option')); $i++) { 			die("here ");				//$this->product_model->Insert_Products_data('tbl_product_printing_price',$insert_data);			}
