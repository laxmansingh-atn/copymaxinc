...
class Orders extends MY_Controller {
	...
	public function change_status(){
		...
		if($insert_order_status_history){
			...
			if($result == true){
				...
				$mail_temp = safe_str_replace("{COMPANY_EMAIL}", '<a href="mailto:sandiegocopiescheap@gmail.com">info@sandiegocopiescheap.com</a>', $mail_temp);
				...
				//$data['to'] = 'copymaxinc@gmail.com,'.($customer_email)?','.$customer_email :'';	
		        $data['to'] = 'sandiegocopiescheap@gmail.com,'.($customer_email)?','.$customer_email :'';
	...
	private function sendMail($data,$image_full_path=null)
    {
		...
		$this->email->reply_to('sandiegocopiescheap@gmail.com', 'San Diego Copies/Print Company');
