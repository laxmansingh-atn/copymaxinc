...
class Users extends MY_Controller {
	...
	public function edituser()
	{
		...
		if(isset($_POST['edit']))
		{
			...
			//$this->form_validation->set_rules('password', 'Password', 'trim|required');
			$this->form_validation->set_rules('email', 'Email', 'trim|required');
			$this->form_validation->set_rules('phone_number', 'Phone Number', 'trim|required');			//$this->form_validation->set_rules('company_name', 'Company Name', 'trim|required');
			//$this->form_validation->set_rules('user_role', 'User Role', 'trim|required');
			$this->form_validation->set_rules('user_status', 'User Status', 'trim|required');
			...
			{				$password = $this->input->post('password');
				...
				$update_data = array(
									...
									'first_name'	=> 	$this->input->post('first_name'),
									'last_name'		=> 	$this->input->post('last_name'),
									'email'			=>	$email,									'phone'			=>	$this->input->post('phone_number'),
									'company'		=>	$this->input->post('company_name'),
									'active'		=>	$this->input->post('user_status'),
									);				if( !empty( $password ) ) {
				...
				$this -> session -> set_flashdata( 'update_message', $error_msg );
			}
