    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
          ...
          <ol class = "breadcrumb">
            ...
            <li class = ""><a href = "<?= base_url('admin/networks') ?>/showall"><?= $page_title;?></a></li>
		...
		?>
          ...
          <div class="col-md-2 txt_right"> <a href="<?= base_url('admin/networks') ?>/add"><button type="button" class="btn btn-success">ADD NEW</button></a></div>
          ...
          <form action="" method="post" enctype="multipart/form-data">
			...
			<!--<div class="row">
			  ...
			  <div class="col-md-6">
			  	...
			  	<div class="form-group"> 
			  		...
			  		<label for="lang" class="control-label">Product Name</label> 

					<select class="form-control brand_lang" name="product_id" >

					<?php foreach($productlist as $list) { ?>

						<option value="<?=$list['product_id']?>" <?php if(!empty($result)) { if($list['product_id'] == $result[0]['product_id'] ){echo "selected='selected'";}} ?>><?=$list['product_name']?></option>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="brand_name" value="<?php if(!empty($result)){ echo $result[0]['brand_name'];}?>" placeholder="Network Name" required="required">
            ...
            <div class="col-md-6">
                ...
                <label>Network Image</label>

                <div class="col-md-10">

                  <div class="input-group image-preview">safe_str_replace(

                    <input type="text" class="form-control image-preview-filename" value="<?php if(!empty($result)){ echo $result[0]['brand_image'];}?>" name="brand_image" id="fieldID" readonly placeholder="Network Image" />
           ...
           <!-- <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="brand_title" id="brand_title" value="<?php if(!empty($result)){ echo $result[0]['value'];}?>" placeholder="Set price for network" required="required">
			...
			<!-- <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="form-group">								 
                                    ...
                                    <textarea class="form-control"  type="text" name="description" id ="description" value="" placeholder="Description" rows="6" cols="6"><?php if(!empty($result)){ echo $result[0]['description'];}?>
              ...
              <a href="<?= base_url('admin/networks/showall/');?>">
                                        ...
                                        <td class="text-center"><div class="btn-group">
                                          ...
                                          <button class="btn btn-default btn-icon dropdown-toggle" data-toggle="dropdown"><i class="fa fa-gears"></i></button>
                                            ...
                                            <ul class="dropdown-menu icons-right dropdown-menu-right" style="padding:0">
                                              ...
                                              <li><a class="edit" href="<?= base_url('admin/networks/edit')."/".$results->id;?>"><i class="fa fa-pencil"></i>Edit</a></li>

                                              <li><a class="delete" href="<?= base_url('admin/networks/delete')."/".$results->id;?>"><i class="fa fa-trash"></i>Remove</a></li>
