                                 ...
                                 <input type="hidden" name="product_id" id="product_attribute_id" value="<?php if(!empty($result)){ echo $result[0]['product_id'];}?>">  
								  ...
								  $storage[$a['storage']] = $a;
							       ...
							       foreach($storage  as  $val){ ?>
                                    <div class="varient-content" data-id="<?=$i?>">	
                                    <div class="row">
									<div class="col-md-4">
									<label>Storage (GB)</label>
									</div>
									<div class="col-md-4">
									<input type="textbox" class="form-control validate" name="storage[]" value="<?php if(!empty($storage)){ echo $val['storage']; } ?>">
									</div>
									<?php if($i != 0){?>
									<div class="form-group"> <a class="remove_btn_varient" class="btn btn-success">Remove Attribute</a> </div>
									<?php } ?>
								   </div>
									...
									<div class="attribute_network">
									 ...
									 <div class="col-md-4">
										 <div class="form-group">
											...
											<select class="form-control selected_val" id="network" name="network[<?=$i?>][]">
											<?php
											
                                             foreach($attributes as $list) {
												 
											echo '<option class="dropdown"';
											//if($attribute['network'] == $list['id'] ){ echo  ' selected' ; } 
											echo ' value="'.$list['id'].'">'.$list['attribute_name'].'</option>' ; 
										 ...
										 <div class="form-group">
                                            ...
                                            <input type="textbox" class="form-control validate" name="price[<?=$i?>][]" id="price_val" placeholder ="price" value="<?php if(!empty($attribute)){ echo $attribute['price'] ; }?>">
                                  ...
                                  <!--<input type="hidden" name="product_id" id="product_attribute_id" value="<?php if(!empty($result)){ echo $result[0]['product_id'];}?>">-->
								   ...
								   <div class="col-md-4">
										 ...
										 <div class="form-group">
											...
											<select class="form-control selected_val" id="attribute_data_0" name="attribute[]">
											<?php
										 ...
										 <div class="form-group">
											...
											<select class="form-control selected_val" id="attr_val0" name="attribute_value[]">
                                         ...
                                         <div class="col-md-3">
										  <label></label>
										 <div class="form-group">                                          
                                        <input type="text" class="form-control validate price_text_" name="dimensions[0]" id="price_val" placeholder ="Dimensions" required="required">
