    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
          <ol class = "breadcrumb">
            ...
            <li class = ""><a href = "<?= base_url('admin/activity/') ?>"><?= $page_title;?></a></li>
          ...
          <?php 
			...
			{
		?>
          <div class="col-md-2 txt_right"> <a href="<?= base_url('admin/activity') ?>/add"><button type="button" class="btn btn-success">ADD NEW</button></a></div>
          <?php
			}
		  ?>
        </div>
          ...
          <form action="" method="post" enctype="multipart/form-data">
			<div class="row">
			  <div class="col-md-6">
				...
				?>
					...
					<select class="form-control activity_lang" name="language_code" >
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="activity_title" name="activity_name" value="<?php if(!empty($result)){ echo $result[0]['activity_title'];}?>" placeholder="Activity Title" required="required">
              </div>
            </div>
			  </div>
           <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                <label>Activity Image</label> <!--(Please provide images with 925x465)-->
                <div class="col-md-10">
                  <div class="input-group image-preview">
                    <input type="text" class="form-control image-preview-filename" readonly placeholder="Activity Image" />
                    ...
                    <div class="btn btn-default image-preview-input"> <span class="fa fa-folder-open"></span> <span class="image-preview-input-title">Image</span>
                      <input type="file" name="activity_image" value="<?php if(!empty($result)){echo $result[0]['activity_image'];}?>"/>
                      <!-- rename it --> 
                    </div>
                    </span> </div>
                </div>
                <div class="col-md-2">
                <?php
                if(empty($result[0]['activity_image']))
				{
                ?>
				...
				{
				?>
                <div class="upload_img"> <img src="<?= base_url().$result[0]['activity_image'];?>" class="img-responsive" style="height:30px;" alt=""> </div>
                <?php
				}
				?>
                </div>
            ...
            <div class="col-md-6">
                ...
                <select class="form-control" name="activity_status" id="" required>
            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" type="text" name="activity_text" id="news_text" placeholder="Activity Text" rows="6" cols="6"><?php if(!empty($result)){ echo $result[0]['activity_content'];}?></textarea>
                  </div>
                </div>
            </div>
          	<hr>
                    		...
                    		<div class="dataTable_wrapper"><!--dataTables_wrapper-->
                    			<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									?>
										<tr>
                                      	<td><?= ($key+1);?></td>
                                        <td style="text-align: center;"><?= $results->activity_title;?></td>
                                        <td style="text-align: center;"><img src="<?= base_url().$results->activity_image;?>" width="200" height="70" /></td>
                                        ...
                                        <td class="text-center"><div class="btn-group">
                                          <button class="btn btn-default btn-icon dropdown-toggle" data-toggle="dropdown"><i class="fa fa-gears"></i></button>
                                            <ul class="dropdown-menu icons-right dropdown-menu-right" style="padding:0">
                                              <li><a class="edit" href="<?= base_url('admin/activity/edit')."/".$results->id;?>"><i class="fa fa-pencil"></i>Edit</a></li>
                                              <li><a class="delete" href="<?= base_url('admin/activity/delete')."/".$results->id;?>"><i class="fa fa-trash"></i>Remove</a></li>
                                            </ul>
                                          </div></td>
                                      </tr>
									<?php
