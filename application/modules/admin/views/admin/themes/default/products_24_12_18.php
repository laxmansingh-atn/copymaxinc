                            ...
                            <div class="row row_block">
							    ...
							    <div class="col-md-6">
								  <div class="form-group">
									...
									<textarea class="form-control" id="page_description"  rows="10" cols="6"><?php if(!empty($result)){ echo $result[0]['description'];}?></textarea>
                ...
                <div class="tab-pane" role="tabpanel" id="step2">
					    <form id="product_attribute">
						 ...
						 <label>PRINTING OPTIONS</label>
							...
							<input type="hidden" name="product_id"  value="<?php if(!empty($result)){ echo $result[0]['product_id'];}?>">
							<?php
								foreach($printing_attributes as $key=>$a) {
                                  echo '<div class="varient-content" data-id="'.$key.'">';									
                               ...
                               <div class="row">
								  <div class="">
								   ...
								   <div class="col-md-4">
									...
									<div class="col-md-4">
									  <label>&nbsp;</label>
										 ...
										 <div class="form-group">
										 <a class="remove_btn_printing btn btn-danger btn-sm">remove</a>
										 </div>
									</div>
								   ...
								   <div class="row add-network-val">
									...
									<div class="col-md-2">
									<input type="number" class="form-control validate" name="quantity_to[<?=$key?>][]" required="required" placeholder="Range to" min = "0" value="<?php echo ($rows->range_to==9223372036854775807)? 0 : $rows->range_to ?>">
									</div>
									<div class="col-md-2">
									...
									<div class="col-md-1">
									     <div class="form-group">
										  <a class="remove_btn_network price_text_ btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
										  </div>
									  </div>
					...
					?>   
                            ...
                            <div class="varient-content" data-id="0">
                                  ...
                                  <input type="hidden" name="pproduct_id" id="printing_product_id" value="">
                        ...
                        <ul class="list-inline pull-right">
								...
								{
								?>
                                <li><button type="button" class="btn btn-primary next-step" id="edit_printing">Edit and continue</button></li>
			  ...
			  <div class="tab-pane" role="tabpanel" id="step3">
					    <form id="finishing_attribute">
						 ...
						 <label>FINISHING OPTIONS</label>
							...
							<input type="hidden" name="fproduct_id" id="finishing_product_id" value="<?php if(!empty($result)){ echo $result[0]['product_id'];}?>">
							<?php
							   
								foreach($finishing_attributes as $key=>$a) { 
								echo '<div class="finishing-content" data-id="'.$key.'">';	
                               ...
                               <div class="row">
								  <div class="">
								   ...
								   <div class="col-md-4">
										 ...
										 <div class="form-group">
										    <input type="hidden" name="cnt[<?=$key?>]"  value="<?=$key?>">   
										<select class="form-control selected_val" id="finishing_data_<?=$key?>" name="attribute[<?=$key?>][<?=$j?>]" onchange="attribute_data('<?=$key?>','parent' ,'finishing')">
											<?php
											echo '<option class="dropdown">Select</option>'; 
								   ...
								   <div class="col-md-4">
										   ...
										   ?>
											<select class="form-control selected_val" id="finishing_val_<?=$key?>" name="attribute_value[<?=$key?>][<?=$j?>]">
											<option>select</option>
											<?php    
									...
									<div class="col-md-4">
									  <label>&nbsp;</label>
										 <div class="form-group">
                                            ...
                                            <a class="remove_btn_finishing btn btn-danger btn-sm">remove</a>
									...
									<input type="number" class="form-control validate" name="price[<?=$key?>][]" required="required" placeholder="price" min = "0" value="<?=$rows->price?>">
									 ...
									 <div class="col-md-2">
										 <div class="form-group">
										  ...
										  <div class="form-group">
										 <a class="remove_finish_btn btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
										 </div>
									</div>
					...
					<?php echo '</div>';} } else { ?>
                            ...
                            <div class="finishing-content" data-id="0">
								<input type="hidden" name="cnt[]"  value="0">   
                                <input type="hidden" name="fproduct_id" id="finishing_product_id" value="">
                      ...
                      <img class="img-responsive" src="<?php echo base_url().'uploads/products/'.$value['product_image'];?>">                                                
							...
							<input type="hidden"  id="product_img_id" name="img_product_id" value="<?php if(!empty($result)){ echo $result[0]['product_id'];}?>">
