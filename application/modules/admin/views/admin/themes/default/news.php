    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
          <ol class = "breadcrumb">
            ...
            <li class = ""><a href = "<?= base_url('admin/news/') ?>"><?= $page_title;?></a></li>
          ...
          <?php 
			...
			{
		?>
          <div class="col-md-2 txt_right"> <a href="<?= base_url('admin/news') ?>/add"><button type="button" class="btn btn-success">ADD NEW</button></a></div>
          <?php
			}
		  ?>
        </div>
          ...
          <form action="" method="post" enctype="multipart/form-data">
			<div class="row">
			  <div class="col-md-6">
				...
				?>
					...
					<select class="form-control news_lang" name="language_code" >
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="news_title" name="news_name" value="<?php if(!empty($result)){ echo $result[0]['news_title'];}?>" placeholder="News Title" required="required">
              </div>
            </div>
			  </div>
           <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                <label>News Image</label> <!--(Please provide images with 925x465)-->
                <div class="col-md-10">
                  <div class="input-group image-preview">
                    <input type="text" class="form-control image-preview-filename" readonly placeholder="News Image" />
                    ...
                    <div class="btn btn-default image-preview-input"> <span class="fa fa-folder-open"></span> <span class="image-preview-input-title">Image</span>
                      <input type="file" name="news_image" value="<?php if(!empty($result)){echo $result[0]['news_image'];}?>"/>
                      <!-- rename it --> 
                    </div>
                    </span> </div>
                </div>
				...
				{
				?>
                <div class="upload_img"> <img src="<?= base_url().$result[0]['news_image'];?>" class="img-responsive" style="height:30px;" alt=""> </div>
                <?php
				}
				?>
                </div>
            ...
            <div class="col-md-6">
                ...
                <select class="form-control" name="news_status" id="" required>
            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" type="text" name="news_text" id="news_text" placeholder="News Text" rows="6" cols="6"><?php if(!empty($result)){ echo $result[0]['news_content'];}?></textarea>
                  </div>
                </div>
            </div>
          	<hr>
                    		...
                    		<div class="dataTable_wrapper"><!--dataTables_wrapper-->
                    			<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									?>
										<tr>
                                      	<td><?= ($key+1);?></td>
                                        <td style="text-align: center;"><?= $results->news_title;?></td>
                                        <td style="text-align: center;"><img src="<?= base_url().$results->news_image;?>" width="200" height="70" /></td>
                                        ...
                                        <td class="text-center"><div class="btn-group">
                                          <button class="btn btn-default btn-icon dropdown-toggle" data-toggle="dropdown"><i class="fa fa-gears"></i></button>
                                            <ul class="dropdown-menu icons-right dropdown-menu-right" style="padding:0">
                                              <li><a class="edit" href="<?= base_url('admin/news/edit')."/".$results->id;?>"><i class="fa fa-pencil"></i>Edit</a></li>
                                              <li><a class="delete" href="<?= base_url('admin/news/delete')."/".$results->id;?>"><i class="fa fa-trash"></i>Remove</a></li>
                                            </ul>
                                          </div></td>
                                      </tr>
									<?php
