                               ...
                               <div class="row">
								  <div class="">
								   ...
								   <div class="row add-network-val">
									...
									<div class="col-md-2">
									<input type="number" class="form-control validate" name="quantity_to[<?=$key?>][]" required="required" placeholder="Range to" min = "0" value="<?php if($rows->range_to==9223372036854775807) echo 0; ?>">
									</div>
									<div class="col-md-2">
