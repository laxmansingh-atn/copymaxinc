								  ...
								  <div class="">
								   ...
								   <div class="col-md-4">
										...
										<select class="form-control selected_val" id="attribute_data_<?=$key?>" name="attribute[]" onchange="attribute_data('<?=$key?>','parent' ,'printing')">
											...
											echo '<option class="dropdown">Select</option>'; 
                                             foreach($attributelist as $list) { echo $a['attribute_id'];
											 echo '<option ';
										      if($list['attribute_id'] == $a['attribute_id']){ 
								   ...
								   <div class="col-md-4">
										  <label>Attribute Values:</label>
											...
											<select class="form-control selected_val" id="attr_val<?=$key?>" name="attribute_value[]">
											<option value="<?=$a['attr_value_id']?>"><?=$a['value']?></option>
								   ...
								   <?php $sql ="SELECT * FROM tbl_product_range_price where product_varient_id = '".$a['product_varient_id']."'";
								  ...
								  <div class="">
								      ...
								      <div class="col-md-4">
										 ...
										 <div class="form-group">
											...
											<select class="form-control selected_val" id="finishing_data_0" name="attribute[]">
											<?php
											echo '<option class="dropdown" selected>Select</option>'; 
                                             foreach($attributelist as $list) {
								   ...
								   <div class="col-md-4">
										  <label>Attribute Values:</label>
											...
											<select class="form-control selected_val" id="finishing_val_0" name="attribute_value[]">
