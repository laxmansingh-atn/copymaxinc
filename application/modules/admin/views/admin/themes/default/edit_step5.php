						...
						<form method="post" action="" enctype="multipart/form-data">
                			<div class="row row_block">
                                <div class="col-md-6">
                                    ...
                                    <img src="<?=base_url()?>uploads/products/<?=$product_image['product_image']?>" width="150" height="150">
                                </div>
				            </div>
                            <!--<p>This is step 1</p>-->
                            <ul class="list-inline pull-right">
                            	<li><button type="submit" name="submit" class="btn btn-primary">Complete</button></li>
                            </ul>
                		</form>
            		</div>
