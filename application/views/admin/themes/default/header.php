...
<html lang="en">
    ...
    <head>
        ...
        <!--<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/admin/fancybox/jquery.fancybox-1.3.4.css" media="screen" />-->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- Navigation -->
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color:#263238;">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= base_url('admin/dashboard') ?>"><!--<strong>LOGO HERE</strong>--><img src="<?= base_url();?>assets/admin/images/logo.png" alt="" height="35"></a>
                    
                </div>
                <!-- /.navbar-header -->

                <ul class="nav navbar-top-links navbar-right">
                <a style="text-decoration:none; color:#FFF;" class="" href="<?= base_url('admin/dashboard') ?>">WELCOME  
					<?php
                    if(isset($this->session->userdata['logged_in']))
					{
						echo " ".$this->session->userdata['logged_in']['firstname']." ".$this->session->userdata['logged_in']['lastname'];
					}
					else
					{ 
						echo "";
