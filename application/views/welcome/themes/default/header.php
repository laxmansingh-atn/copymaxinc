...
<link href="<?php echo base_url();?>assets/frontend/css/style.css?asapa" rel="stylesheet" type="text/css">
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/frontend/css/jquery-confirm.min.css">

<script src="<?php echo base_url();?>assets/frontend/js/jquery-3.2.1.min.js"></script>

<!-- Google Tag Manager code added on 28-04-2022 -->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-M3XSSVG');</script>
<!-- End Google Tag Manager code added on 28-04-2022 -->

<?php
/*
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-2215916-1"></script>
<script>
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());

gtag('config', 'UA-2215916-1');
</script>
*/ ?>
<?php
/* //-- Commented by sandy on 28-04-2022 
<!-- Global site tag (gtag.js) - Google Ads: 1057061507 --> 
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-1057061507"></script>
<script> 
	window.dataLayer = window.dataLayer || []; 
	function gtag(){dataLayer.push(arguments);} 
	gtag('js', new Date()); 
	gtag('config', 'AW-1057061507'); 
</script> 

<!-- Event snippet for Purchase 11.12.21 conversion page In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. --> 
<script> 
	function gtag_report_conversion(url){ 
		var callback = function () { if (typeof(url) != 'undefined') { window.location = url; } }; 
		gtag('event', 'conversion', { 'send_to': 'AW-1057061507/CVI8CL6H14IDEIP1hfgD', 'transaction_id': '', 'event_callback': callback }); return false; } 
</script> 
//-- Commented by end sandy on 28-04-2022 
*/
?>
<script> 
function blink_text() {
...
<script> var _ctct_m = "f4b0bec3e0ad50fbd1e7144aa29023b9"; </script>
<script id="signupScript" src="//static.ctctcdn.com/js/signup-form-widget/current/signup-form-widget.min.js" async defer></script>
<!-- End Constant Contact Active Forms -->

<!--Add the following script at the bottom of the web page (before </body></html>)-->
<script type="text/javascript">function add_chatinline(){var hccid=12636730;var nt=document.createElement("script");nt.async=true;nt.src="https://mylivechat.com/chatinline.aspx?hccid="+hccid;var ct=document.getElementsByTagName("script")[0];ct.parentNode.insertBefore(nt,ct);}
add_chatinline();</script>
</head>

<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M3XSSVG"
  ...
  <div class="header_top">
    <div class="header_top_inner clearfix">
      ...
      <div class="contact_part">
        <ul>
          <li><a href="tel:18442679629"> <img src="<?php echo base_url();?>assets/frontend/images/call-icon.png" alt="icon"> <span>Call Us:</span> 1-844-267-9629</a> </li>
          ...
          <li style="padding-left: 10px;">
            <form name="PrePage" method="post" action="https://Simplecheckout.authorize.net/payment/CatalogPayment.aspx">
               <input type="hidden" name="LinkId" value="520b59d4-5680-4d0f-832c-343c33ff11cf" />
               <input name="s1" type="submit" value="Make Payment" />
            </form>
		  </li>
        </ul>
      </div>
