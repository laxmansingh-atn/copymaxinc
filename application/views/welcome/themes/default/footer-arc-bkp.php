    ...
    <div class="row">
        ...
        <div class="col-md-8 col-sm-12">
          <div class="row clearfix">
            ...
            <div class="col-md-4 col-sm-4 no_pad_right">
              <div class="ft_header">
                <h2>Contact Us</h2>
                <h4>Order pickup location only: </h4>
              </div>
              <div class="contact_info">
                <p>1914 Hacienda Drive in Vista, CA 92081</p>
                <p>Phone : <a href="tel:1-844-Copymax (2679629)">1-844-Copymax (2679629)</a></p>
                <p>Email : <a href="mailto:info@sandiegocopiescheap.com" data-email="info@sandiegocopiescheap.com" class="sendcontactmessage">info@copymaxinc.com</a></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="footer_btm">
        <div class="col-md-12 col-sm-12">
          <p class="copyright">© <?php echo date('Y');?> <span>Copy Max Inc</span>. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
     ...
     <form method="POST" id="product_info_modal_form" name="product_info_modal_form">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <h4>Contact No : 1-800 DAYCOPY (329.2679) </h4>
         ...
         <form action="  <?= base_url()?>welcome/index/contactsendemail" method="post" enctype="multipart/form-data">
            <div class="modal-body">
               ...
               <!--<div class="form-group"> 
					...
					<input type="hidden" required class="form-control email_to" name="emailTo" value="sandiegocopiescheap@gmail.com">		  
				<!--</div>-->
               <div class="form-group">
    ...
    <div class="row clearfix">
      ...
      <div class="col-md-12 col-sm-12">
        <div class="login_share_ad">
          ...
          <h5>Help your friends save money: Tip them off about San Diego copies and prints</h5>
          <ul>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<p>Copy Max Inc  1-844-Copymax (2679629)</p>
			</div>
		  </div>
		</div>
	  </div>
