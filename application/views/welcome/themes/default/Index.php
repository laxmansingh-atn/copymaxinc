...
class Index extends MY_Controller
{
	...
	public function contactsendemail(){
		...
		$arc_mail_ids = array("info@copymaxinc.com", "sales@copymaxinc.com", "copymaxinc@gmail.com");
	
		if ($_POST['from_email'] && $_POST['emailTo'] && in_array($_POST['emailTo'], $arc_mail_ids) && $_POST['subject'] && $_POST['message']) {
