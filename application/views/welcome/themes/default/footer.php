	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<p>Copymax Inc.  1-844-267-9629</p>
			</div>
		  </div>
		</div>
	  </div>
...
*/
?>
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/frontend/css/bootstrap-datepicker3.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/frontend/css/bootstrap-datepicker3.standalone.min.css">
...
<script src="<?php echo base_url();?>assets/frontend/js/bootbox.min.js" type="text/javascript" ></script>
<script src="<?php echo base_url();?>assets/frontend/js/bootstrap-datepicker.min.js" type="text/javascript" ></script> 
