...
class Index extends MY_Controller
{
        ...
        if ($this->input->post()) {
            ...
            if (empty($folding_price['price'])) {
                ...
                //} else {
                    ...
                    $total_folding_price = $folding_price['price'] * $total_folding_pages;										if($total_folding_price < 10){												$total_folding_price = 10;											}
                //}
            }
	...
	public function contactsendemail(){
		...
		if ($_POST['from_email'] && $_POST['emailTo'] && in_array($_POST['emailTo'],["info@sandiegocopiescheap.com","sales@sandiegocopiescheap.com","sandiegocopiescheap@gmail.com"]) && $_POST['subject'] && $_POST['message']) {
			...
			/* Email to Admin */
				...
				if ($this->sendContactUsMail($data)) {
            ...
            $message = '<body style="padding: 0;margin: 0;background-color: #fff;font-family: "Open Sans", sans-serif;">
                        ...
                        <tr>
                            <td>
                                ©2020 San Diego copy company.All rights reserved.
                            </td>
                        </tr>
                        </table>
            ...
            $data['to'] = $email;
            $data['name'] = 'San Diego Copies/Print Company';
            $data['subject'] = 'Enquiry';
            $data['message'] = $message;
            $data['from'] = $_POST['emailTo'];
    ...
    public function contact_us_add()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $data['message'] = $message;
            $data['from'] = 'info@sandiegocopiescheap.com';
            ...
            ### Mail to Admin ############### 
            $mail_temp = file_get_contents('./global/mail/contactus_template.html');
            $mail_temp = safe_str_replace("{logo}", base_url('./assets/frontend/images/logo.png'), $mail_temp);
          
            $mail_temp = safe_str_replace("{description}", $this->input->post('message'), $mail_temp);
            $mail_temp = safe_str_replace("{subject}", $this->input->post('subject'), $mail_temp);
            $mail_temp = safe_str_replace("{full_name}", $this->input->post('first_name') . ' ' . $this->input->post('last_name'), $mail_temp);
            $mail_temp = safe_str_replace("{phone}", $this->input->post('phone_no'), $mail_temp);
            $mail_temp = safe_str_replace("{email}", $this->input->post('email'), $mail_temp);
            $mail_temp = safe_str_replace("{current_year}", date('Y'), $mail_temp);

           // $data['to'] = 'copymaxinc@gmail.com';
            $data['to'] = 'sandiegocopiescheap@gmail.com';
            //$data['to']='arindam.biswas@met-technologies.com,arindamkbiswas@gmail.com';
            $data['name'] = 'San Diego Copies/Print Company';
            $data['subject'] = 'San Diego Copies/Print Company - Contact Us';
    ...
    public function newsletter_submit_form()
    {
		...
		//$data['to'] = 'rakesh.freak6@gmail.com';
		$data['to'] = 'sandiegocopiescheap@gmail.com';
		$data['name'] = 'Hi';
		$data['subject'] = 'Newsletter Signup';
		$data['message'] = "<p> A new Newsletter sign Up from <a href='https://www.sandiegocopiescheap.com/'>https://www.sandiegocopiescheap.com/</a></p>			<p>Email Id: $newsletter_email</p>	 <p>Name : $newsletter_name</p>	";
		$data['from'] = 'info@sandiegocopiescheap.com';
		$this->sendMailContactUs($data);		
                ...
                if ($isExists != true) {
                    ...
                    if ($this->ion_auth->register('', $this->input->post('reg_password'), $this->input->post('reg_email'), array(
                        ...
                        <pre style="color: #000;font-size: 16px;line-height: 22px;margin: 0 0 20px 0;font-family:Lucida Grande,Lucida Sans Unicode,Lucida Sans,DejaVu Sans,Verdana,sans-serif;">
                          ...
                          <p> Contact No : 1-800 DAYCOPY (329.2679)</p>
                        ...
                        <tr>
                        <td>
                        ' . date('Y') . ' San Diego copy company. since ' . date('Y') . '
                        </td>
                        </tr>
                        <tr>
                        <td>
                        ©' . date('Y') . ' San Diego copy company. All rights reserved.
                        </td>
                        </tr>
                        </table>
                        ...
                        $data['name'] = 'San Diego Copies/Print Company';
                        $data['subject'] = 'Register with San Diego Copies/Print Company';
                        $data['message'] = $message;
    ...
    public function place_order(){
        ...
        if ($this->input->post('place_order')) {
            ...
            if ($this->input->post('payment_method') == 'card') {
                $response = $this->authorized($insert_address, $insert_order);
 ...
 */
                        ...
                        foreach ($this->cart->contents() as $cart) {
                            ...
                            if (isset($cart['image'])) {
                                ...
                                $table_footer = '
                                        ...
                                        $mail_temp = safe_str_replace("{LOGO}", base_url('./assets/frontend/images/logo.png'), $mail_temp);
                                        $mail_temp = safe_str_replace("{COMPANY_NAME}", "San Diego Copies/Print Company", $mail_temp);
                                        $mail_temp = safe_str_replace("{COMPANY_ADDRESS}", '1914 Hacienda drive, Vista, CA 92081', $mail_temp);
                                        $mail_temp = safe_str_replace("{COMPANY_PHONE}", '1-800 DAYCOPY (329.2679)', $mail_temp);
                                        $mail_temp = safe_str_replace("{COMPANY_EMAIL}", 'info@sandiegocopiescheap.com', $mail_temp);
                                        $mail_temp = safe_str_replace("{COMPANY_EMAIL_NEW}", 'sandiegocopiescheap@gmail.com', $mail_temp);
                                        ...
                                        //$data['to']='arindam.biswas@met-technologies.com,arindamkbiswas@gmail.com';
                                        $data['name'] = 'San Diego Copies/Print Company';
                                        $data['subject'] = 'San Diego Copies/Print Company - Order Placed';
                                        $data['message'] = $mail_temp;
                                        $data['from'] = 'info@sandiegocopiescheap.com';
										
                                        $this->sendMailContactUs($data, $images_full_path,$invoice_path=null);
										$data['to'] = "php.freak6@gmail.com";
                                        $this->sendMailContactUs($data, $images_full_path,$invoice_path=null);
    ...
    private function authorized($address, $order){
        ...
        //$merchantAuthentication->setName("44HYne7G6");                    //Sandbox
        //$merchantAuthentication->setTransactionKey("6rSP28KjU39JQ6d5");   //Sandbox
        ...
        //print_r($response->getMessages()->getMessage());
        //die;
        return $response;
    }
            ...
            if ($this->form_validation->run() != FALSE) {
                ...
                if (count($result) > 0) {
                    ...
                    $message = "<html>
                                    ...
                                    <p>&nbsp;</p>
                                    <p>Best Regards,<br/>San Diego Copies/Print Company Team</p>
                                    </body>
                                    </html>";
	...
	private function sendContactUsMail($data, $image_full_path = null,$invoice_path = null)
    {
        ...
        $this->email->set_crlf("\r\n");
        $this->email->from('query@sandiegocopiescheap.com', 'San Diego Copies/Print Company');
        //$this->email->reply_to('Reply',$data['from']);
        $this->email->to($data['to']);
        //$this->email->bcc("sandiegocopiescheap@gmail.com");       
    ...
    private function sendMail($data, $image_full_path = null,$invoice_path = null)
    {
        ...
        $this->email->initialize($config);
        $this->email->set_crlf("\r\n");
        $this->email->from('info@sandiegocopiescheap.com', 'San Diego Copies/Print Company');
        $this->email->to($data['to']);
        $this->email->subject($data['subject']);
        $this->email->message($data['message']);
    ...
    //     $this->email->from('info@sandiegocopiescheap.com', 'Copymax');
    //     $this->email->to($data['to']);
